...
export const ProfileAvatar = () => {
  ...
  return (
    <Container>
      <Tooltip title={user.name || ""} translate="no">
        <IconButton
          id="basic-button"
      ...
      >
        ...
        >
          ...
          <h2>
            <span style={{ color: "#7764E8" }}>Filmo</span>
          </h2>
        </LogoContainer>
        ...
        {user.name == "" ? (
          ...
          <div>
            ...
            <StyledMenuItem
              translate="no"
              onClick={() => {
                window.open("https://github.com/tunji98/");
              }}
            >
              <GitHub /> &nbsp; Github{" "}
              {stars && (
        ...
        <CreditsContainer translate="no">
          ...
          <a style={{ textDecoration: "none", color: "inherit" }} href="https://github.com/tunji97">
